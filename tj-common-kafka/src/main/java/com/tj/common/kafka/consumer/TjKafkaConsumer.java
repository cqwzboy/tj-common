 ...
 *
 */
public class TjKafkaConsumer {

	private final static ResourceBundle rs = ResourceBundle.getBundle("kafka");
	 ...
	 * @param callBack
	 */
	public static void receiveMsg(String topic, KafkaReceiveMsgCallBack callBack) {
	 ...
	 * @param callBack
	 */
	public static void receiveBlockingMsg(String topic, int blockingSize, KafkaReceiveMsgCallBack callBack) {
	 ...
	 * @param callBack
	 */
	public static void receiveMsgByOffset(String topic, int partitionNum, long offset, KafkaReceiveMsgCallBack callBack) {

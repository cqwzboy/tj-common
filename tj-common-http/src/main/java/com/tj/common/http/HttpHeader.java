...
public class HttpHeader {
	 ...
	 * @return
	 */
	public HttpHeader contentEncoding(String contentEncoding) {
		headerMaps.put(HttpReqHead.CONTENT_ENCODING,
				new BasicHeader(HttpReqHead.CONTENT_ENCODING, contentEncoding));
		return this;
	}
	...
	public static class Headers{
		...
		public static final String ENCODING_BY_GZIP="gzip";
